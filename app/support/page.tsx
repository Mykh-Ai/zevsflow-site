...
export default function SupportPage() {
  return <LegalLayout title="Kontakt a podpora" intro="Napíšte nám, s čím potrebujete pomôcť alebo ktorý opakujúci sa firemný proces chcete zjednodušiť.">
    <section><h2>Pilot jedného procesu</h2><p>Pre platený pilot za 200 € použite krátku <Link href="/pilot">žiadosť o pilot</Link>. Formulár neprijíma súbory ani platby a jeho odoslanie nie je objednávkou.</p></section>
    <section><h2>Všeobecný obchodný dopyt</h2><p>Email: <a href="mailto:officezevs2024@gmail.com?subject=ZevsFlow%20%E2%80%93%20obchodn%C3%BD%20dopyt">officezevs2024@gmail.com</a>.</p></section>
    ...
    <section><h2>Podpora</h2><p>Rozsah a reakčný čas podpory sa určujú podľa konkrétnej ponuky alebo dohody s klientom.</p></section>
  </LegalLayout>;
}
