...
export default function SupportPage() {
  return <LegalLayout title="Kontakt a podpora" intro="Napíšte nám, s čím potrebujete pomôcť alebo ktorý opakujúci sa firemný proces chcete zjednodušiť.">
    ...
    <section><h2>Všeobecný obchodný dopyt</h2><p>Email: <a href="mailto:info@zevsflow.sk?subject=ZevsFlow%20%E2%80%93%20obchodn%C3%BD%20dopyt">info@zevsflow.sk</a>.</p></section>
