...
export default function SupportPage() {
  return <LegalLayout title="Kontakt a podpora" intro="Jeden kontaktný bod pre pracovný náhľad OfficeFlow. Samostatné firemné adresy a produkčné servisné podmienky sa doplnia pred verejným spustením.">
    ...
    <section><h2>Servisné úrovne</h2><p>Aktuálny súkromný náhľad nemá garantovanú reakčnú dobu ani nepretržitú podporu. Konkrétne časy podpory a riešenia incidentov budú súčasťou ponuky alebo produkčných podmienok.</p></section>
  </LegalLayout>;
}
