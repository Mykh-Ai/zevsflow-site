...
export const metadata: Metadata = { title: "Podmienky používania | OfficeFlow", description: "Pracovný návrh podmienok používania webu a riešení OfficeFlow." };

export default function TermsPage() {
  return <LegalLayout title="Podmienky používania" intro="Tieto pracovné podmienky opisujú základné pravidlá webu a budúcich riešení OfficeFlow. Konkrétna zákazková implementácia sa riadi samostatnou ponukou a zmluvou.">
    <section><h2>1. Poskytovateľ</h2><p>OfficeFlow je pracovné označenie riešení prevádzkovateľa Zevs s. r. o., IČO: 56055552, Karpatské námestie 7770/10A, 831 06 Bratislava – mestská časť Rača.</p></section>
    ...
    <section><h2>5. AI a obmedzenia</h2><p>AI môže nesprávne porozumieť nejednoznačnému alebo nekvalitnému vstupu. Preto sa výpočty, formáty a zapisujúce operácie podľa možností oddeľujú do kontrolovaného kódu a dôležité kroky čakajú na človeka. OfficeFlow nesľubuje bezchybnosť ani úplné odstránenie rizika.</p></section>
    <section><h2>6. Externé služby</h2><p>Funkcia môže závisieť od Telegramu, WhatsAppu, Google, hostingu, emailu, platobnej služby alebo AI poskytovateľa. Ich dostupnosť a pravidlá OfficeFlow nemôže úplne ovládať. Konkrétne závislosti budú uvedené v ponuke alebo produktovej dokumentácii.</p></section>
