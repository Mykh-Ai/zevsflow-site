...
export default function CookiesPage() {
  return <LegalLayout title="Cookies" intro="Web ZevsFlow nepoužíva Google Analytics, reklamné pixely, heatmapy ani marketingové cookies.">
    ...
    <section><h2>5. Nastavenia prehliadača</h2><p>Cookies a úložiská môžete kontrolovať vo svojom prehliadači. Pri obmedzení nevyhnutných technológií môžete žiadosť poslať priamo na <a href="mailto:info@zevsflow.sk">info@zevsflow.sk</a>.</p></section>
  </LegalLayout>;
}
