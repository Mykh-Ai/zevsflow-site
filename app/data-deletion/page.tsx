...
export default function DataDeletionPage() {
  return <LegalLayout title="Vymazanie údajov" intro="Tu nájdete spôsob, ako odpojiť Google integráciu a požiadať o vymazanie údajov zo žiadosti o pilot alebo z dohodnutého riešenia ZevsFlow.">
    ...
    <section><h2>2. Žiadosť adresovaná ZevsFlow</h2><p>Pošlite žiadosť na <a href="mailto:info@zevsflow.sk?subject=ZevsFlow%20%E2%80%93%20vymazanie%20%C3%BAdajov">info@zevsflow.sk</a> s predmetom „ZevsFlow – vymazanie údajov“. Uveďte kontaktný email, názov firmy a či sa žiadosť týka formulára pilotu, konkrétneho projektu alebo Google pripojenia. Do emailu neposielajte heslá, tokeny ani citlivé dokumenty.</p></section>
